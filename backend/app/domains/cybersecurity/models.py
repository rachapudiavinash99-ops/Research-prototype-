...
class CybersecurityExperiment(Base):
    __tablename__ = "cybersecurity_experiments"
...
class CybersecurityFinding(Base):
...
class CybersecurityDataPoint(Base):
    __tablename__ = "cybersecurity_datapoints"
    id = Column(Integer, primary_key=True, index=True)
    experiment_id = Column(Integer, index=True)
