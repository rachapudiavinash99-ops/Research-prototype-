...
class LawExperiment(Base):
    __tablename__ = "law_experiments"
...
class LawFinding(Base):
    __tablename__ = "law_findings"
    id = Column(Integer, primary_key=True, index=True)
...
class LawDataPoint(Base):
    __tablename__ = "law_datapoints"
    id = Column(Integer, primary_key=True, index=True)
    experiment_id = Column(Integer, index=True)
